    ...
    async function loadMovies() {
      ...
      try {
        ...
        if (selectedGenre) {
          ...
          res = await movieApi.getMoviesByCategory('phim-bo', currentPage);
        }
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs sm:text-sm text-gray-400">
              Tổng hợp phim truyền hình dài tập từ Hàn Quốc, Trung Quốc, Thái Lan, Âu Mỹ
            </p>
          </div>
        </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-16 bg-dark-card rounded-2xl border border-dark-border my-6">
          <p className="text-gray-400 text-sm">
            Không tìm thấy phim bộ nào phù hợp với bộ lọc đã chọn.
          </p>
          <button
            onClick={handleResetFilters}
            className="mt-4 px-4 py-2 rounded-xl bg-brand-gold text-black text-xs font-bold"
          >
            Khôi phục bộ lọc
          </button>
        </div>
